...
float compare()
{
    ...
    if (strcmp(str1[guess], str1[0]) == 0)
    {
        ...
        {
            cout << "Same guess!"
                 << "Both guess are: " << str1[guess] << endl;
            ++eq;
        }
        ...
        {
            cout << "The PC won!"
                 << "You guess: " << str1[guess] << ". PC guess: " << str1[num] << endl;
            ++lose;
        }
...
{
    cout << "ez kellene legyen a won: " << won << endl;
    cout << "ez kellene legyen a round: " << round << endl;
    cout << "Percent did you won: " << ((double)won / (double)round) * 100 << "%" << endl;
}
